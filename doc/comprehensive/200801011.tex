...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.5]{images/cs1}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.35]{images/register-classes.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.35]{images/xml2rdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.35]{images/qm}
...
\begin{figure}[t]
    \centering
    \includegraphics[scale=0.35]{images/single-v-cluster.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.35]{images/xml2rdf-accu}
...
\begin{figure*}[h]
    \centering
    \includegraphics[scale=0.5]{images/xml2rdf1}
    \caption{System architecture}
    \label{fig:xml2rdf1}
\end{figure*}
...
\begin{figure*}[h]
    \centering
    \includegraphics[scale=0.5]{images/xml2rdf2}
    \caption{System architecture}
    \label{fig:xml2rdf2}
\end{figure*}
...
\begin{figure*}[h]
    \centering
    \includegraphics[scale=0.5]{images/xml2rdf3}
    \caption{System architecture}
    \label{fig:xml2rdf3}
\end{figure*}
...
\begin{figure*}[h]
    \centering
    \includegraphics[scale=0.5]{images/xml2rdf4}
    \caption{System architecture}
    \label{fig:xml2rdf4}
\end{figure*}
